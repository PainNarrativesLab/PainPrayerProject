...
/**
 * This class defines the structure of the 'u_races' table.
 *
 *
 *
...
class RaceTableMap extends TableMap
{
     ...
     */
    const COL_RACE = 'u_races.race';

    /**
     * the column name for the created_at field
     */
    const COL_CREATED_AT = 'u_races.created_at';

    /**
     * the column name for the updated_at field
     */
    const COL_UPDATED_AT = 'u_races.updated_at';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Race', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('race', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(RaceTableMap::COL_RACE, RaceTableMap::COL_CREATED_AT, RaceTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('race', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Race' => 0, 'CreatedAt' => 1, 'UpdatedAt' => 2, ),
        self::TYPE_CAMELNAME     => array('race' => 0, 'createdAt' => 1, 'updatedAt' => 2, ),
        self::TYPE_COLNAME       => array(RaceTableMap::COL_RACE => 0, RaceTableMap::COL_CREATED_AT => 1, RaceTableMap::COL_UPDATED_AT => 2, ),
        self::TYPE_FIELDNAME     => array('race' => 0, 'created_at' => 1, 'updated_at' => 2, ),
        self::TYPE_NUM           => array(0, 1, 2, )
    );
    ...
    {
        // attributes
        $this->setName('u_races');
        $this->setPhpName('Race');
        $this->setIdentifierQuoting(false);
        $this->setClassName('\\Race');
        $this->setPackage('');
        $this->setUseIdGenerator(false);
        // columns
        $this->addPrimaryKey('race', 'Race', 'VARCHAR', true, 200, null);
    ...
    public static function getPrimaryKeyHashFromRow($row, $offset = 0, $indexType = TableMap::TYPE_NUM)
    {
        ...
        if ($row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('Race', TableMap::TYPE_PHPNAME, $indexType)] === null) {
            return null;
        }

        return (string) $row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('Race', TableMap::TYPE_PHPNAME, $indexType)];
    }
    ...
    public static function getPrimaryKeyFromRow($row, $offset = 0, $indexType = TableMap::TYPE_NUM)
    {
        return (string) $row[
            $indexType == TableMap::TYPE_NUM
                ? 0 + $offset
                : self::translateFieldName('Race', TableMap::TYPE_PHPNAME, $indexType)
        ];
    }
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(RaceTableMap::COL_RACE);
            $criteria->addSelectColumn(RaceTableMap::COL_CREATED_AT);
            $criteria->addSelectColumn(RaceTableMap::COL_UPDATED_AT);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Race) { // it's a model object
            // create criteria based on pk values
            $criteria = $values->buildPkeyCriteria();
        } else { // it's a primary key, or an array of pks
            $criteria = new Criteria(RaceTableMap::DATABASE_NAME);
            $criteria->add(RaceTableMap::COL_RACE, (array) $values, Criteria::IN);
        }
