...
/**
 * Base class that represents a row from the 'u_races' table.
 *
 *
 *
...
abstract class Race implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\RaceTableMap';
    ...
    /**
     * Initializes internal state of Base\Race object.
     */
     ...
     * @return $this|\Race The current object (for fluent API support)
     */
    public function setRace($v)
    {
        ...
        if ($this->race !== $v) {
            $this->race = $v;
            $this->modifiedColumns[RaceTableMap::COL_RACE] = true;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            if ($this->created_at === null || $dt === null || $dt->format("Y-m-d H:i:s") !== $this->created_at->format("Y-m-d H:i:s")) {
                ...
                $this->modifiedColumns[RaceTableMap::COL_CREATED_AT] = true;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            if ($this->updated_at === null || $dt === null || $dt->format("Y-m-d H:i:s") !== $this->updated_at->format("Y-m-d H:i:s")) {
                ...
                $this->modifiedColumns[RaceTableMap::COL_UPDATED_AT] = true;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : RaceTableMap::translateFieldName('Race', TableMap::TYPE_PHPNAME, $indexType)];
            $this->race = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : RaceTableMap::translateFieldName('CreatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->created_at = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : RaceTableMap::translateFieldName('UpdatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            return $startcol + 3; // 3 = RaceTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Race'), 0, $e);
        }
    }
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(RaceTableMap::COL_CREATED_AT)) {
                    $this->setCreatedAt(time());
                }
                if (!$this->isColumnModified(RaceTableMap::COL_UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            } else {
                $ret = $ret && $this->preUpdate($con);
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(RaceTableMap::COL_UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            }
            if ($ret) {
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(RaceTableMap::COL_RACE)) {
        ...
        $sql = sprintf(
            'INSERT INTO u_races (%s) VALUES (%s)',
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(RaceTableMap::COL_RACE)) {
            $criteria->add(RaceTableMap::COL_RACE, $this->race);
        }
        if ($this->isColumnModified(RaceTableMap::COL_CREATED_AT)) {
            $criteria->add(RaceTableMap::COL_CREATED_AT, $this->created_at);
        }
        if ($this->isColumnModified(RaceTableMap::COL_UPDATED_AT)) {
            $criteria->add(RaceTableMap::COL_UPDATED_AT, $this->updated_at);
        }
    ...
    /**
     * Generic method to set the primary key (race column).
     *
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Race (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Race Clone of current object.
     * @throws PropelException
     */
