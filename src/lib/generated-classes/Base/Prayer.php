...
/**
 * Base class that represents a row from the 'prayers' table.
 *
 *
 *
* @package    propel.generator..Base
*/
abstract class Prayer implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\PrayerTableMap';
    ...
    /**
     * Initializes internal state of Base\Prayer object.
     */
    ...
    /**
     * Compares this with another <code>Prayer</code> instance.  If
     * <code>obj</code> is an instance of <code>Prayer</code>, delegates to
     * <code>equals(Prayer)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Prayer The current object, for fluid interface
     */
     ...
     * @return $this|\Prayer The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[PrayerTableMap::COL_ID] = true;
        }
    ...
    public function setText($v)
    {
        ...
        if ($this->text !== $v) {
            $this->text = $v;
            $this->modifiedColumns[PrayerTableMap::COL_TEXT] = true;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            if ($this->created_at === null || $dt === null || $dt->format("Y-m-d H:i:s") !== $this->created_at->format("Y-m-d H:i:s")) {
                ...
                $this->modifiedColumns[PrayerTableMap::COL_CREATED_AT] = true;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            if ($this->updated_at === null || $dt === null || $dt->format("Y-m-d H:i:s") !== $this->updated_at->format("Y-m-d H:i:s")) {
                ...
                $this->modifiedColumns[PrayerTableMap::COL_UPDATED_AT] = true;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : PrayerTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : PrayerTableMap::translateFieldName('Text', TableMap::TYPE_PHPNAME, $indexType)];
            $this->text = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : PrayerTableMap::translateFieldName('CreatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->created_at = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : PrayerTableMap::translateFieldName('UpdatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            return $startcol + 4; // 4 = PrayerTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Prayer'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildPrayerQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Prayer::setDeleted()
     * @see Prayer::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildPrayerQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(PrayerTableMap::COL_CREATED_AT)) {
                    $this->setCreatedAt(time());
                }
                if (!$this->isColumnModified(PrayerTableMap::COL_UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            } else {
                $ret = $ret && $this->preUpdate($con);
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(PrayerTableMap::COL_UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            }
            if ($ret) {
                ...
                $this->postSave($con);
                PrayerTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $this->modifiedColumns[PrayerTableMap::COL_ID] = true;
        if (null !== $this->id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . PrayerTableMap::COL_ID . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(PrayerTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(PrayerTableMap::COL_TEXT)) {
        ...
        $sql = sprintf(
            'INSERT INTO prayers (%s) VALUES (%s)',
    ...
    {
        $pos = PrayerTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Prayer'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Prayer'][$this->hashCode()] = true;
        $keys = PrayerTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getText(),
    ...
    {
        $criteria = new Criteria(PrayerTableMap::DATABASE_NAME);

        if ($this->isColumnModified(PrayerTableMap::COL_ID)) {
            $criteria->add(PrayerTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(PrayerTableMap::COL_TEXT)) {
            $criteria->add(PrayerTableMap::COL_TEXT, $this->text);
        }
        if ($this->isColumnModified(PrayerTableMap::COL_CREATED_AT)) {
            $criteria->add(PrayerTableMap::COL_CREATED_AT, $this->created_at);
        }
        if ($this->isColumnModified(PrayerTableMap::COL_UPDATED_AT)) {
            $criteria->add(PrayerTableMap::COL_UPDATED_AT, $this->updated_at);
        }
    ...
    {
        $criteria = ChildPrayerQuery::create();
        $criteria->add(PrayerTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Prayer (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Prayer Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildPrayer is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildPrayer The current object (for fluent API support)
     */
    public function setTrialPrayerAssociations(Collection $trialPrayerAssociations, ConnectionInterface $con = null)
    {
        ...
        foreach ($trialPrayerAssociationsToDelete as $trialPrayerAssociationRemoved) {
            $trialPrayerAssociationRemoved->setPrayer(null);
        }
    ...
    protected function doAddTrialPrayerAssociation(ChildTrialPrayerAssociation $trialPrayerAssociation)
    {
        ...
        $trialPrayerAssociation->setPrayer($this);
    }
    ...
    public function removeTrialPrayerAssociation(ChildTrialPrayerAssociation $trialPrayerAssociation)
    {
        if ($this->getTrialPrayerAssociations()->contains($trialPrayerAssociation)) {
            ...
            $trialPrayerAssociation->setPrayer(null);
        }
     ...
     * Otherwise if this Prayer is new, it will return
     * an empty collection; or if this Prayer has previously
     * been saved, it will retrieve related TrialPrayerAssociations from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Prayer.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
     ...
     * @return ObjectCollection|ChildTrialPrayerAssociation[] List of ChildTrialPrayerAssociation objects
     */
    public function getTrialPrayerAssociationsJoinTrial(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildTrialPrayerAssociationQuery::create(null, $criteria);
     ...
     * @return ChildPrayer The current object (for fluent API support)
     */
    ...
    protected function doAddTrial(ChildTrial $trial)
    {
        ...
        $trialPrayerAssociation->setTrial($trial);
        ...
        if (!$trial->isPrayersLoaded()) {
            $trial->initPrayers();
            $trial->getPrayers()->push($this);
        } elseif (!$trial->getPrayers()->contains($this)) {
            $trial->getPrayers()->push($this);
        }
    ...
    {
        if ($this->getTrials()->contains($trial)) { $trialPrayerAssociation = new ChildTrialPrayerAssociation();

            $trialPrayerAssociation->setTrial($trial);
            if ($trial->isPrayersLoaded()) {
                //remove the back reference if available
                $trial->getPrayers()->removeObject($this);
            }
    ...
    {
        return (string) $this->exportTo(PrayerTableMap::DEFAULT_STRING_FORMAT);
    }
