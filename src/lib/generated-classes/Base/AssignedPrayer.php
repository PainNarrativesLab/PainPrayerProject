...
/**
 * Base class that represents a row from the 'assigned_prayer' table.
 *
 *
 *
* @package    propel.generator..Base
*/
abstract class AssignedPrayer implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\AssignedPrayerTableMap';
    ...
    /**
     * Initializes internal state of Base\AssignedPrayer object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>AssignedPrayer</code> instance.  If
     * <code>obj</code> is an instance of <code>AssignedPrayer</code>, delegates to
     * <code>equals(AssignedPrayer)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|AssignedPrayer The current object, for fluid interface
     */
     ...
     */
    public function getPrayerDate($format = NULL)
    {
        if ($format === null) {
            return $this->prayer_date;
        } else {
            return $this->prayer_date instanceof \DateTime ? $this->prayer_date->format($format) : null;
        }
    }
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[AssignedPrayerTableMap::COL_ID] = true;
        }
    ...
    public function setComplete($v)
    {
        ...
        if ($this->complete !== $v) {
            $this->complete = $v;
            $this->modifiedColumns[AssignedPrayerTableMap::COL_COMPLETE] = true;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            if ($this->created_at === null || $dt === null || $dt->format("Y-m-d H:i:s") !== $this->created_at->format("Y-m-d H:i:s")) {
                ...
                $this->modifiedColumns[AssignedPrayerTableMap::COL_CREATED_AT] = true;
            }
        } // if either are not null
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            if ($this->updated_at === null || $dt === null || $dt->format("Y-m-d H:i:s") !== $this->updated_at->format("Y-m-d H:i:s")) {
                ...
                $this->modifiedColumns[AssignedPrayerTableMap::COL_UPDATED_AT] = true;
            }
        } // if either are not null
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildAssignedPrayerQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see AssignedPrayer::setDeleted()
     * @see AssignedPrayer::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildAssignedPrayerQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(AssignedPrayerTableMap::COL_CREATED_AT)) {
                    $this->setCreatedAt(time());
                }
                if (!$this->isColumnModified(AssignedPrayerTableMap::COL_UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            } else {
                $ret = $ret && $this->preUpdate($con);
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(AssignedPrayerTableMap::COL_UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            }
            if ($ret) {
                ...
                $this->postSave($con);
                AssignedPrayerTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $sql = sprintf(
            'INSERT INTO assigned_prayer (%s) VALUES (%s)',
    ...
    {
        $pos = AssignedPrayerTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['AssignedPrayer'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['AssignedPrayer'][$this->hashCode()] = true;
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(AssignedPrayerTableMap::COL_CREATED_AT)) {
            $criteria->add(AssignedPrayerTableMap::COL_CREATED_AT, $this->created_at);
        }
        if ($this->isColumnModified(AssignedPrayerTableMap::COL_UPDATED_AT)) {
            $criteria->add(AssignedPrayerTableMap::COL_UPDATED_AT, $this->updated_at);
        }
    ...
    {
        $criteria = ChildAssignedPrayerQuery::create();
        $criteria->add(AssignedPrayerTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \AssignedPrayer (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \AssignedPrayer Clone of current object.
     * @throws PropelException
     */
    ...
    public function setagent(ChildUser $v = null)
    {
        ...
        if ($v !== null) {
            $v->addAssignedPrayerRelatedByAgentId($this);
        }
    ...
    public function setpatient(ChildUser $v = null)
    {
        ...
        // If this object has already been added to the ChildUser object, it will not be re-added.
        if ($v !== null) {
            $v->addAssignedPrayerRelatedByPatientId($this);
        }
    ...
    {
        return (string) $this->exportTo(AssignedPrayerTableMap::DEFAULT_STRING_FORMAT);
    }
     ...
     *
     * @return     $this|ChildAssignedPrayer The current object (for fluent API support)
     */
