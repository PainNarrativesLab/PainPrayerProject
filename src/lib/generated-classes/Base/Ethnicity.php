...
/**
 * Base class that represents a row from the 'u_ethnicities' table.
 *
 *
 *
* @package    propel.generator..Base
*/
abstract class Ethnicity implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\EthnicityTableMap';
    ...
    /**
     * Initializes internal state of Base\Ethnicity object.
     */
    ...
    /**
     * Compares this with another <code>Ethnicity</code> instance.  If
     * <code>obj</code> is an instance of <code>Ethnicity</code>, delegates to
     * <code>equals(Ethnicity)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Ethnicity The current object, for fluid interface
     */
     ...
     * @return $this|\Ethnicity The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[EthnicityTableMap::COL_ID] = true;
        }
    ...
    public function setIdentity($v)
    {
        ...
        if ($this->identity !== $v) {
            $this->identity = $v;
            $this->modifiedColumns[EthnicityTableMap::COL_IDENTITY] = true;
        }
    ...
    public function setType($v)
    {
        ...
        if ($this->type !== $v) {
            $this->type = $v;
            $this->modifiedColumns[EthnicityTableMap::COL_TYPE] = true;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            if ($this->created_at === null || $dt === null || $dt->format("Y-m-d H:i:s") !== $this->created_at->format("Y-m-d H:i:s")) {
                ...
                $this->modifiedColumns[EthnicityTableMap::COL_CREATED_AT] = true;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            if ($this->updated_at === null || $dt === null || $dt->format("Y-m-d H:i:s") !== $this->updated_at->format("Y-m-d H:i:s")) {
                ...
                $this->modifiedColumns[EthnicityTableMap::COL_UPDATED_AT] = true;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : EthnicityTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : EthnicityTableMap::translateFieldName('Identity', TableMap::TYPE_PHPNAME, $indexType)];
            $this->identity = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : EthnicityTableMap::translateFieldName('Type', TableMap::TYPE_PHPNAME, $indexType)];
            $this->type = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : EthnicityTableMap::translateFieldName('CreatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->created_at = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : EthnicityTableMap::translateFieldName('UpdatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            return $startcol + 5; // 5 = EthnicityTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Ethnicity'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildEthnicityQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Ethnicity::setDeleted()
     * @see Ethnicity::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildEthnicityQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(EthnicityTableMap::COL_CREATED_AT)) {
                    $this->setCreatedAt(time());
                }
                if (!$this->isColumnModified(EthnicityTableMap::COL_UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            } else {
                $ret = $ret && $this->preUpdate($con);
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(EthnicityTableMap::COL_UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            }
            if ($ret) {
                ...
                $this->postSave($con);
                EthnicityTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $this->modifiedColumns[EthnicityTableMap::COL_ID] = true;
        if (null !== $this->id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . EthnicityTableMap::COL_ID . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(EthnicityTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(EthnicityTableMap::COL_IDENTITY)) {
            $modifiedColumns[':p' . $index++]  = 'identity';
        }
        if ($this->isColumnModified(EthnicityTableMap::COL_TYPE)) {
        ...
        $sql = sprintf(
            'INSERT INTO u_ethnicities (%s) VALUES (%s)',
    ...
    {
        $pos = EthnicityTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Ethnicity'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Ethnicity'][$this->hashCode()] = true;
        $keys = EthnicityTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getIdentity(),
            $keys[2] => $this->getType(),
    ...
    {
        $criteria = new Criteria(EthnicityTableMap::DATABASE_NAME);

        if ($this->isColumnModified(EthnicityTableMap::COL_ID)) {
            $criteria->add(EthnicityTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(EthnicityTableMap::COL_IDENTITY)) {
            $criteria->add(EthnicityTableMap::COL_IDENTITY, $this->identity);
        }
        if ($this->isColumnModified(EthnicityTableMap::COL_TYPE)) {
            $criteria->add(EthnicityTableMap::COL_TYPE, $this->type);
        }
        if ($this->isColumnModified(EthnicityTableMap::COL_CREATED_AT)) {
            $criteria->add(EthnicityTableMap::COL_CREATED_AT, $this->created_at);
        }
        if ($this->isColumnModified(EthnicityTableMap::COL_UPDATED_AT)) {
            $criteria->add(EthnicityTableMap::COL_UPDATED_AT, $this->updated_at);
        }
    ...
    {
        $criteria = ChildEthnicityQuery::create();
        $criteria->add(EthnicityTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Ethnicity (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Ethnicity Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildEthnicity is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildEthnicity The current object (for fluent API support)
     */
    public function setUserDemoss(Collection $userDemoss, ConnectionInterface $con = null)
    {
        ...
        foreach ($userDemossToDelete as $userDemosRemoved) {
            $userDemosRemoved->setEthnicity(null);
        }
     ...
     * Otherwise if this Ethnicity is new, it will return
     * an empty collection; or if this Ethnicity has previously
     * been saved, it will retrieve related UserDemoss from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Ethnicity.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
     ...
     * @return ObjectCollection|ChildUserDemos[] List of ChildUserDemos objects
     */
    public function getUserDemossJoinUser(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildUserDemosQuery::create(null, $criteria);
    ...
    {
        return (string) $this->exportTo(EthnicityTableMap::DEFAULT_STRING_FORMAT);
    }
