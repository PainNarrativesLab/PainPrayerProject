...
/**
 * Base class that represents a query for the 'prayers' table.
 *
 *
 *
 * @method     ChildPrayerQuery orderById($order = Criteria::ASC) Order by the id column
 * @method     ChildPrayerQuery orderByText($order = Criteria::ASC) Order by the text column
 * @method     ChildPrayerQuery orderByCreatedAt($order = Criteria::ASC) Order by the created_at column
 * @method     ChildPrayerQuery orderByUpdatedAt($order = Criteria::ASC) Order by the updated_at column
 *
 * @method     ChildPrayerQuery groupById() Group by the id column
 * @method     ChildPrayerQuery groupByText() Group by the text column
 * @method     ChildPrayerQuery groupByCreatedAt() Group by the created_at column
 * @method     ChildPrayerQuery groupByUpdatedAt() Group by the updated_at column
 *
 ...
 *
 * @method     ChildPrayerQuery leftJoinTrialPrayerAssociation($relationAlias = null) Adds a LEFT JOIN clause to the query using the TrialPrayerAssociation relation
 * @method     ChildPrayerQuery rightJoinTrialPrayerAssociation($relationAlias = null) Adds a RIGHT JOIN clause to the query using the TrialPrayerAssociation relation
 * @method     ChildPrayerQuery innerJoinTrialPrayerAssociation($relationAlias = null) Adds a INNER JOIN clause to the query using the TrialPrayerAssociation relation
 *
 * @method     \TrialPrayerAssociationQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
 ...
 *
 * @method     ChildPrayer findOneById(int $id) Return the first ChildPrayer filtered by the id column
 * @method     ChildPrayer findOneByText(string $text) Return the first ChildPrayer filtered by the text column
 * @method     ChildPrayer findOneByCreatedAt(string $created_at) Return the first ChildPrayer filtered by the created_at column
 * @method     ChildPrayer findOneByUpdatedAt(string $updated_at) Return the first ChildPrayer filtered by the updated_at column *
 ...
 *
 * @method     ChildPrayer requireOneById(int $id) Return the first ChildPrayer filtered by the id column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildPrayer requireOneByText(string $text) Return the first ChildPrayer filtered by the text column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 ...
 * @method     ChildPrayer requireOneByUpdatedAt(string $updated_at) Return the first ChildPrayer filtered by the updated_at column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 ...
 * @method     ChildPrayer[]|ObjectCollection findById(int $id) Return ChildPrayer objects filtered by the id column
 * @method     ChildPrayer[]|ObjectCollection findByText(string $text) Return ChildPrayer objects filtered by the text column
 ...
 * @method     ChildPrayer[]|ObjectCollection findByUpdatedAt(string $updated_at) Return ChildPrayer objects filtered by the updated_at column
...
abstract class PrayerQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'main', $modelName = '\\Prayer', $modelAlias = null)
    {
    ...
    public function findPk($key, ConnectionInterface $con = null)
    {
        ...
        if ((null !== ($obj = PrayerTableMap::getInstanceFromPool((string) $key))) && !$this->formatter) {
    ...
    {
        $sql = 'SELECT id, text, created_at, updated_at FROM prayers WHERE id = :p0';
        try {
        ...
        if ($row = $stmt->fetch(\PDO::FETCH_NUM)) {
            ...
            $obj = new ChildPrayer();
            $obj->hydrate($row);
            PrayerTableMap::addInstanceToPool($obj, (string) $key);
        }
        $stmt->closeCursor();
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        return $this->addUsingAlias(PrayerTableMap::COL_ID, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(PrayerTableMap::COL_ID, $keys, Criteria::IN);
    }
    ...
    public function filterById($id = null, $comparison = null)
    {
        if (is_array($id)) {
            $useMinMax = false;
            if (isset($id['min'])) {
                $this->addUsingAlias(PrayerTableMap::COL_ID, $id['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($id['max'])) {
                $this->addUsingAlias(PrayerTableMap::COL_ID, $id['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(PrayerTableMap::COL_ID, $id, $comparison);
    }
    ...
    public function filterByText($text = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(PrayerTableMap::COL_TEXT, $text, $comparison);
    }
    ...
    public function filterByUpdatedAt($updatedAt = null, $comparison = null)
    {
        if (is_array($updatedAt)) {
            ...
            if (isset($updatedAt['min'])) {
                $this->addUsingAlias(PrayerTableMap::COL_UPDATED_AT, $updatedAt['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($updatedAt['max'])) {
                $this->addUsingAlias(PrayerTableMap::COL_UPDATED_AT, $updatedAt['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(PrayerTableMap::COL_UPDATED_AT, $updatedAt, $comparison);
    }
    ...
    public function filterByTrialPrayerAssociation($trialPrayerAssociation, $comparison = null)
    {
        if ($trialPrayerAssociation instanceof \TrialPrayerAssociation) {
            return $this
                ->addUsingAlias(PrayerTableMap::COL_ID, $trialPrayerAssociation->getPrayerId(), $comparison);
    ...
    {
        if ($prayer) {
            $this->addUsingAlias(PrayerTableMap::COL_ID, $prayer->getId(), Criteria::NOT_EQUAL);
        }
    ...
    /**
     * Deletes all rows from the prayers table.
     *
    ...
    {
        return $this->addUsingAlias(PrayerTableMap::COL_UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(PrayerTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(PrayerTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(PrayerTableMap::COL_CREATED_AT);
    }
    ...
    {
        return $this->addUsingAlias(PrayerTableMap::COL_CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(PrayerTableMap::COL_CREATED_AT);
    }
