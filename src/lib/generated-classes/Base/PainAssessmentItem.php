...
/**
 * Base class that represents a row from the 'pain_rating_items' table.
 *
 *
 *
* @package    propel.generator..Base
*/
abstract class PainAssessmentItem implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\PainAssessmentItemTableMap';
    ...
    /**
     * @var        ObjectCollection|ChildTrial[] Cross Collection to store aggregation of ChildTrial objects.
     */
     ...
     * @var ObjectCollection|ChildTrial[]
     */
    protected $trialsScheduledForDeletion = null;
    ...
    /**
     * Initializes internal state of Base\PainAssessmentItem object.
     */
    ...
    /**
     * Compares this with another <code>PainAssessmentItem</code> instance.  If
     * <code>obj</code> is an instance of <code>PainAssessmentItem</code>, delegates to
     * <code>equals(PainAssessmentItem)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|PainAssessmentItem The current object, for fluid interface
     */
     ...
     * @return $this|\PainAssessmentItem The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[PainAssessmentItemTableMap::COL_ID] = true;
        }
    ...
    public function setText($v)
    {
        ...
        if ($this->text !== $v) {
            $this->text = $v;
            $this->modifiedColumns[PainAssessmentItemTableMap::COL_TEXT] = true;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            if ($this->created_at === null || $dt === null || $dt->format("Y-m-d H:i:s") !== $this->created_at->format("Y-m-d H:i:s")) {
                ...
                $this->modifiedColumns[PainAssessmentItemTableMap::COL_CREATED_AT] = true;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            if ($this->updated_at === null || $dt === null || $dt->format("Y-m-d H:i:s") !== $this->updated_at->format("Y-m-d H:i:s")) {
                ...
                $this->modifiedColumns[PainAssessmentItemTableMap::COL_UPDATED_AT] = true;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : PainAssessmentItemTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : PainAssessmentItemTableMap::translateFieldName('Text', TableMap::TYPE_PHPNAME, $indexType)];
            $this->text = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : PainAssessmentItemTableMap::translateFieldName('CreatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->created_at = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : PainAssessmentItemTableMap::translateFieldName('UpdatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            return $startcol + 4; // 4 = PainAssessmentItemTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\PainAssessmentItem'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildPainAssessmentItemQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see PainAssessmentItem::setDeleted()
     * @see PainAssessmentItem::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildPainAssessmentItemQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(PainAssessmentItemTableMap::COL_CREATED_AT)) {
                    $this->setCreatedAt(time());
                }
                if (!$this->isColumnModified(PainAssessmentItemTableMap::COL_UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            } else {
                $ret = $ret && $this->preUpdate($con);
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(PainAssessmentItemTableMap::COL_UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            }
            if ($ret) {
                ...
                $this->postSave($con);
                PainAssessmentItemTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doSave(ConnectionInterface $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->trialsScheduledForDeletion !== null) {
                if (!$this->trialsScheduledForDeletion->isEmpty()) {
                    $pks = array();
                    foreach ($this->trialsScheduledForDeletion as $entry) {
                        $entryPk = [];
                    ...
                    $this->trialsScheduledForDeletion = null;
                }

            }

            if ($this->collTrials) {
                foreach ($this->collTrials as $trial) {
                    if (!$trial->isDeleted() && ($trial->isNew() || $trial->isModified())) {
                        $trial->save($con);
                    }
                }
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $this->modifiedColumns[PainAssessmentItemTableMap::COL_ID] = true;
        if (null !== $this->id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . PainAssessmentItemTableMap::COL_ID . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(PainAssessmentItemTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(PainAssessmentItemTableMap::COL_TEXT)) {
        ...
        $sql = sprintf(
            'INSERT INTO pain_rating_items (%s) VALUES (%s)',
    ...
    {
        $pos = PainAssessmentItemTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['PainAssessmentItem'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['PainAssessmentItem'][$this->hashCode()] = true;
        $keys = PainAssessmentItemTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getText(),
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\PainAssessmentItem
     */
    ...
    {
        $criteria = new Criteria(PainAssessmentItemTableMap::DATABASE_NAME);

        if ($this->isColumnModified(PainAssessmentItemTableMap::COL_ID)) {
            $criteria->add(PainAssessmentItemTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(PainAssessmentItemTableMap::COL_TEXT)) {
            $criteria->add(PainAssessmentItemTableMap::COL_TEXT, $this->text);
        }
        if ($this->isColumnModified(PainAssessmentItemTableMap::COL_CREATED_AT)) {
            $criteria->add(PainAssessmentItemTableMap::COL_CREATED_AT, $this->created_at);
        }
        if ($this->isColumnModified(PainAssessmentItemTableMap::COL_UPDATED_AT)) {
            $criteria->add(PainAssessmentItemTableMap::COL_UPDATED_AT, $this->updated_at);
        }
    ...
    {
        $criteria = ChildPainAssessmentItemQuery::create();
        $criteria->add(PainAssessmentItemTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \PainAssessmentItem (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \PainAssessmentItem Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildPainAssessmentItem is new, it will return
        ...
        if (null === $this->collTrialPainRatingAssociations || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collTrialPainRatingAssociations) {
                ...
                $collTrialPainRatingAssociations = ChildTrialPainRatingAssociationQuery::create(null, $criteria)
                    ->filterByPainAssessmentItem($this)
                    ->find($con);
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildPainAssessmentItem The current object (for fluent API support)
     */
    public function setTrialPainRatingAssociations(Collection $trialPainRatingAssociations, ConnectionInterface $con = null)
    {
        ...
        foreach ($trialPainRatingAssociationsToDelete as $trialPainRatingAssociationRemoved) {
            $trialPainRatingAssociationRemoved->setPainAssessmentItem(null);
        }
    ...
    protected function doAddTrialPainRatingAssociation(ChildTrialPainRatingAssociation $trialPainRatingAssociation)
    {
        ...
        $trialPainRatingAssociation->setPainAssessmentItem($this);
    }
    ...
    public function removeTrialPainRatingAssociation(ChildTrialPainRatingAssociation $trialPainRatingAssociation)
    {
        if ($this->getTrialPainRatingAssociations()->contains($trialPainRatingAssociation)) {
            ...
            $trialPainRatingAssociation->setPainAssessmentItem(null);
        }
     ...
     * Otherwise if this PainAssessmentItem is new, it will return
     * an empty collection; or if this PainAssessmentItem has previously
     * been saved, it will retrieve related TrialPainRatingAssociations from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in PainAssessmentItem.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
     ...
     * @return ObjectCollection|ChildTrialPainRatingAssociation[] List of ChildTrialPainRatingAssociation objects
     */
    public function getTrialPainRatingAssociationsJoinTrial(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildTrialPainRatingAssociationQuery::create(null, $criteria);
        $query->joinWith('Trial', $joinBehavior);

        return $this->getTrialPainRatingAssociations($query, $con);
    }

    /**
     * Clears out the collTrials collection
     *
     * This does not modify the database; however, it will remove any associated objects, causing
     * them to be refetched by subsequent calls to accessor method.
     *
    ...
    {
        $this->collTrials = null; // important to set this to NULL since that means it is uninitialized
    }

    /**
     * Initializes the collTrials crossRef collection.
     *
     * By default this just sets the collTrials collection to an empty collection (like clearTrials());
     * however, you may wish to override this method in your stub class to provide setting appropriate
     * to your application -- for example, setting the initial array to the values stored in database.
     *
     * @return void
    ...
    {
        $this->collTrials = new ObjectCollection();
        $this->collTrialsPartial = true;

        $this->collTrials->setModel('\Trial');
    }

    /**
     * Checks if the collTrials collection is loaded.
     *
     * @return bool
     */
    public function isTrialsLoaded()
    {
        return null !== $this->collTrials;
    }

    /**
     * Gets a collection of ChildTrial objects related by a many-to-many relationship
     ...
     * @param      ConnectionInterface $con Optional connection object
     *
     * @return ObjectCollection|ChildTrial[] List of ChildTrial objects
     */
    public function getTrials(Criteria $criteria = null, ConnectionInterface $con = null)
    {
        $partial = $this->collTrialsPartial && !$this->isNew();
        if (null === $this->collTrials || null !== $criteria || $partial) {
            if ($this->isNew()) {
                // return empty collection
                if (null === $this->collTrials) {
                    $this->initTrials();
                }
            } else {

                $query = ChildTrialQuery::create(null, $criteria)
                    ->filterByPainAssessmentItem($this);
                $collTrials = $query->find($con);
                if (null !== $criteria) {
                    return $collTrials;
                }

                if ($partial && $this->collTrials) {
                    //make sure that already added objects gets added to the list of the database.
                    foreach ($this->collTrials as $obj) {
                        if (!$collTrials->contains($obj)) {
                            $collTrials[] = $obj;
                        }
                    }
                }

                $this->collTrials = $collTrials;
                $this->collTrialsPartial = false;
            }
        }
    ...
    /**
     * Sets a collection of Trial objects related by a many-to-many relationship
     * to the current object by way of the trialsXpain_items cross-reference table.
     * It will also schedule objects for deletion based on a diff between old objects (aka persisted)
     * and new objects from the given Propel collection.
     *
     * @param  Collection $trials A Propel collection.
     * @param  ConnectionInterface $con Optional connection object
     * @return $this|ChildPainAssessmentItem The current object (for fluent API support)
     */
    public function setTrials(Collection $trials, ConnectionInterface $con = null)
    {
        $this->clearTrials();
        $currentTrials = $this->getTrials();

        $trialsScheduledForDeletion = $currentTrials->diff($trials);

        foreach ($trialsScheduledForDeletion as $toDelete) {
            $this->removeTrial($toDelete);
        }

        foreach ($trials as $trial) {
            if (!$currentTrials->contains($trial)) {
                $this->doAddTrial($trial);
            }
        }

        $this->collTrialsPartial = false;
        $this->collTrials = $trials;

        return $this;
    }

    /**
     * Gets the number of Trial objects related by a many-to-many relationship
     * to the current object by way of the trialsXpain_items cross-reference table.
     *
     * @param      Criteria $criteria Optional query object to filter the query
     ...
     * @param      ConnectionInterface $con Optional connection object
     *
     * @return int the number of related Trial objects
     */
    public function countTrials(Criteria $criteria = null, $distinct = false, ConnectionInterface $con = null)
    {
        $partial = $this->collTrialsPartial && !$this->isNew();
        if (null === $this->collTrials || null !== $criteria || $partial) {
            if ($this->isNew() && null === $this->collTrials) {
                return 0;
            } else {

                if ($partial && !$criteria) {
                    return count($this->getTrials());
                }
            ...
            return count($this->collTrials);
        }
    }

    /**
     * Associate a ChildTrial to this object
     * through the trialsXpain_items cross reference table.
     *
     * @param ChildTrial $trial
     * @return ChildPainAssessmentItem The current object (for fluent API support)
     */
    public function addTrial(ChildTrial $trial)
    {
        if ($this->collTrials === null) {
            $this->initTrials();
        }

        if (!$this->getTrials()->contains($trial)) {
            // only add it if the **same** object is not already associated
            $this->collTrials->push($trial);
            $this->doAddTrial($trial);
        }
     ...
     * @param ChildTrial $trial
     */
    protected function doAddTrial(ChildTrial $trial)
    {
        $trialPainRatingAssociation = new ChildTrialPainRatingAssociation();

        $trialPainRatingAssociation->setTrial($trial);
        ...
        if (!$trial->isPainAssessmentItemsLoaded()) {
            $trial->initPainAssessmentItems();
            $trial->getPainAssessmentItems()->push($this);
        } elseif (!$trial->getPainAssessmentItems()->contains($this)) {
            $trial->getPainAssessmentItems()->push($this);
        }
    ...
    /**
     * Remove trial of this object
     * through the trialsXpain_items cross reference table.
     *
     * @param ChildTrial $trial
     * @return ChildPainAssessmentItem The current object (for fluent API support)
     */
    public function removeTrial(ChildTrial $trial)
    {
        if ($this->getTrials()->contains($trial)) { $trialPainRatingAssociation = new ChildTrialPainRatingAssociation();

            $trialPainRatingAssociation->setTrial($trial);
            if ($trial->isPainAssessmentItemsLoaded()) {
                //remove the back reference if available
                $trial->getPainAssessmentItems()->removeObject($this);
            }
            ...
            $this->collTrials->remove($this->collTrials->search($trial));

            if (null === $this->trialsScheduledForDeletion) {
                $this->trialsScheduledForDeletion = clone $this->collTrials;
                $this->trialsScheduledForDeletion->clear();
            }

            $this->trialsScheduledForDeletion->push($trial);
        }
    ...
    {
        return (string) $this->exportTo(PainAssessmentItemTableMap::DEFAULT_STRING_FORMAT);
    }
